...
background processing frameworks out there, though there are not many adapters
implemented yet. However, implementing an adapter is very easy.
...
** others might follow (it's really easy to write an adapter).
