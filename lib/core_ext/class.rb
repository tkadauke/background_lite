class Class
  ...
  # Executes the given method in a background task, or decorates a method to be executed in the background.
  #
  # === Decorate a method.
  #
  ...
  #           If none is specified, the BackgroundLite::Config.default_handler is used. Available handlers
  ...
  # you need to write a background task that accepts and executes the block. See BackgroundLite::ActiveMessagingHandler
